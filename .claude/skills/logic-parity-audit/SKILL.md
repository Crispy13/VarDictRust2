...
5. The parity rules are available in .claude/instructions/rust-parity.instructions.md for type mapping, ordering, null handling, formatting, and traceability checks.
...
4. The parity rules in .claude/instructions/rust-parity.instructions.md when a finding touches types, ordering, nulls, float formatting, or traceability
...
Use a deliberate self-review pass to review your result.
