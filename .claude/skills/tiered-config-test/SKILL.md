...
- Drift between this doc, the TSV, and `tests/common/mod.rs::CONFIG_PRESETS` is enforced by `scripts/check_preset_drift.sh` (see `.claude/workflows/parity.yml`).
