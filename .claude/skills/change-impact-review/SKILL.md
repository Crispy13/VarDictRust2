...
- `src/`, `scripts/`, `.claude/agents/`, `.claude/skills/`, `.claude/instructions/`, and `.claude/workflows/`
...
- In the skill-only config-E2E workflow, the current Claude Code session records this gate-mode verdict. Because this is not independent subagent review, surface any non-`PERF_SAFE` verdict to the user before acceptance.
