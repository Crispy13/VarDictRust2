...
#[test]
fn parity_config_e2e_push() {
    run_config_e2e_suite(
        Some(PUSH_INDICES),
        "bash scripts/gen_e2e_golden_tsv.sh --push-only --all-configs",
    );
}

#[test]
#[ignore = "Nightly config E2E - see parity_config_e2e_push for fast gate"]
