...
The Phase 1 workflow inventory tracks 16 current skills under `.codex/skills/*/`. Each skill file is read for its name, description, trigger contexts, which agents reference it, any agent names mentioned in the body, any file paths referenced, and its workflow phases.
