...
- `src/`, `scripts/`, `.github/agents/`, `.codex/skills/`, `.github/instructions/`, and `.github/workflows/`
...
- In the skill-only config-E2E workflow, the current Codex session records this gate-mode verdict. Because this is not independent custom-agent review, surface any non-`PERF_SAFE` verdict to the user before acceptance.
