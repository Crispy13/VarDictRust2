...
Based on profile results, plan where and what to improve in codebase, write code yourself. `CLI-orchestrator` mode directs you to delegate tasks not related to planning, research or orchestration, and you maybe delegate optimization tasks. But planning and writing code is the most important step in optimization process, so you must do it yourself because you have more context than subagents.
